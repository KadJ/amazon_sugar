<?php /* Smarty version 2.6.11, created on 2014-08-07 11:43:35
         compiled from themes/MetroThemePro/tpls/_headerModuleList.tpl.tpl */ ?>
{*
/*********************************************************************************
...
<script>
{/literal}
    {if true==<?php echo $this->_tpl_vars['show_preview']; ?>
}
       var show_preview=true;
    {else}
       var show_preview=false;
    {/if} 
    {if true==<?php echo $this->_tpl_vars['show_related']; ?>
}
...
<div id="moduleList">
<ul>
    {if true==<?php echo $this->_tpl_vars['show_logo']; ?>
}
      {if $AUTHENTICATED}
      <li>
...
{if $AUTHENTICATED}
  <div id="toptools" >
     ...
     {if true==<?php echo $this->_tpl_vars['show_notific']; ?>
}
