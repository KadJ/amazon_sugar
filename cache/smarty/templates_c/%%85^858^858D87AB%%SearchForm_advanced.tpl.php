<?php /* Smarty version 2.6.11, created on 2014-08-07 11:57:11
         compiled from cache/modules/Accounts/SearchForm_advanced.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/Accounts/SearchForm_advanced.tpl', 26, false),array('function', 'math', 'cache/modules/Accounts/SearchForm_advanced.tpl', 27, false),array('function', 'sugar_getimagepath', 'cache/modules/Accounts/SearchForm_advanced.tpl', 35, false),array('function', 'sugar_translate', 'cache/modules/Accounts/SearchForm_advanced.tpl', 44, false),array('function', 'html_options', 'cache/modules/Accounts/SearchForm_advanced.tpl', 406, false),array('function', 'sugar_getimage', 'cache/modules/Accounts/SearchForm_advanced.tpl', 474, false),)), $this); ?>
...
' class="help-search">
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='phone_fax_advanced'><?php echo smarty_function_sugar_translate(array('label' => 'LBL_FAX','module' => 'Accounts'), $this);?>
</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			

<?php if (strlen ( $this->_tpl_vars['fields']['phone_fax_advanced']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['phone_fax_advanced']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['phone_fax_advanced']['value']);  endif; ?>  

<input type='text' name='<?php echo $this->_tpl_vars['fields']['phone_fax_advanced']['name']; ?>
' id='<?php echo $this->_tpl_vars['fields']['phone_fax_advanced']['name']; ?>
