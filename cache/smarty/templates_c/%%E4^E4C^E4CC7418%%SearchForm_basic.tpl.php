<?php /* Smarty version 2.6.11, created on 2014-08-07 11:49:05
         compiled from cache/modules/lm_TechnicalSupport/SearchForm_basic.tpl */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'counter', 'cache/modules/lm_TechnicalSupport/SearchForm_basic.tpl', 33, false),array('function', 'math', 'cache/modules/lm_TechnicalSupport/SearchForm_basic.tpl', 34, false),array('function', 'sugar_translate', 'cache/modules/lm_TechnicalSupport/SearchForm_basic.tpl', 43, false),array('function', 'sugar_getimagepath', 'cache/modules/lm_TechnicalSupport/SearchForm_basic.tpl', 130, false),array('modifier', 'count', 'cache/modules/lm_TechnicalSupport/SearchForm_basic.tpl', 117, false),)), $this); ?>
...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> <?php echo smarty_function_sugar_translate(array('label' => 'LBL_NAME','module' => 'lm_TechnicalSupport'), $this);?>
...
' title=''      accesskey='9'  >
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='ticket_number_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_TICKET_NUMBER','module' => 'lm_TechnicalSupport'), $this);?>
</label>
    	</td>
...
<?php if (strlen ( $this->_tpl_vars['fields']['ticket_number_basic']['value'] ) <= 0):  $this->assign('value', $this->_tpl_vars['fields']['ticket_number_basic']['default_value']);  else:  $this->assign('value', $this->_tpl_vars['fields']['ticket_number_basic']['value']);  endif; ?>  
<input type='text' name='<?php echo $this->_tpl_vars['fields']['ticket_number_basic']['name']; ?>
' 
    id='<?php echo $this->_tpl_vars['fields']['ticket_number_basic']['name']; ?>
' size='30' 
...
' title='' tabindex='' > 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' ><?php echo smarty_function_sugar_translate(array('label' => 'LBL_CURRENT_USER_FILTER','module' => 'lm_TechnicalSupport'), $this);?>
</label>
    	</td>
