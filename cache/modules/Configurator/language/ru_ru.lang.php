...
To configure additional system settings, click <a href="index.php?module=Administration&action=index" target="_blank">here</a>.',
  ...
  'LBL_LOGO' => 'Логотип',
  'LBL_MANAGE_ASTERISK' => 'Конфигурация ASTERISK',
  'LBL_ASTERISK_HOST' => 'Хост',
  'LBL_ASTERISK_PORT' => 'Порт',
  'LBL_ASTERISK_USER' => 'Пользователь',
  'LBL_ASTERISK_SECRET' => 'Пароль',
  'LBL_ASTERISK_PREFIX' => 'Dialout префикс',
  'LBL_ASTERISK_DIALINPREFIX' => 'Dialin префикс',
  'LBL_ASTERISK_CONTEXT' => 'Контекст',
  'LBL_ASTERISK_EXPR' => 'Регексп для входящих/исходящих звонков',
  'LBL_ASTERISK_EXPR_DESC' => 'Regular expression to match incoming calls',
  'LBL_ASTERISK_SOAPUSER' => 'Asterisk Soap-Юзер',
  'LBL_ASTERISK_LOG_FILE' => 'Путь к лог-файлу',
  'LBL_ASTERISK_DIALOUT_CHANNEL' => 'Канал Dialout',
  'LBL_ASTERISK_DIALOUT_CHANNEL_DESC' => 'Регулярное выражение, ### будет заменено на расширение текущего пользователя',
  'LBL_ASTERISK_DIALIN_EXT_MATCH' => 'Дополнительный регексп для расширений пользователей',
  'LBL_ASTERISK_CALL_SUBJECT_INBOUND_ABBR' => 'Префикс темы для входящих звонков',
  'LBL_ASTERISK_CALL_SUBJECT_OUTBOUND_ABBR' => 'Префикс темы для исходящих звонков',
  'LBL_ASTERISK_CALL_SUBJECT_MAX_LENGTH' => 'Макс. длина темы',
  'LBL_ASTERISK_LISTENER_POLL_RATE' => 'Частота опроса AJAX в миллисекундах',
);