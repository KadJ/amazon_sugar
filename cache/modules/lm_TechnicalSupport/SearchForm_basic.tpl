...
<tr>
	...
	<td scope="row" nowrap="nowrap" width='1%' >
			<label for='name_basic'> {sugar_translate label='LBL_NAME' module='lm_TechnicalSupport'}
		</td>
...
<input type='text' name='{$fields.name_basic.name}' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='ticket_number_basic' >{sugar_translate label='LBL_TICKET_NUMBER' module='lm_TechnicalSupport'}</label>
    	</td>

	
	<td  nowrap="nowrap" width='1%'>
			
{if strlen($fields.ticket_number_basic.value) <= 0}
{assign var="value" value=$fields.ticket_number_basic.default_value }
{else}
{assign var="value" value=$fields.ticket_number_basic.value }
{/if}  
<input type='text' name='{$fields.ticket_number_basic.name}' 
    id='{$fields.ticket_number_basic.name}' size='30' 
	...
	<td scope="row" nowrap="nowrap" width='1%' >
		...
		<label for='current_user_only_basic' >{sugar_translate label='LBL_CURRENT_USER_FILTER' module='lm_TechnicalSupport'}</label>
    	</td>
