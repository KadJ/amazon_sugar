...
addToValidate('form_QuickCreate_Contacts', 'title_pdf_1_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE_PDF_1' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'title_pdf_2_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE_PDF_2' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'fio_assign_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_FIO_ASSIGN' module='Contacts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Contacts', 'title_pdf_3_c', 'varchar', false,'{/literal}{sugar_translate label='LBL_TITLE_PDF_3' module='Contacts' for_js=true}{literal}' );
