...
',
  ...
  'LBL_UW_PREFLIGHT_TESTS_PASSED2' => 'Нажмите на кнопку <i>Вперед</i> для загрузки файлов обновления в систему.',
  ...
  'LBL_UW_START_DESC' => 'Добро пожаловать в мастер обновления. Мастер создан для того, чтобы помочь администратору в процессе обновлении системы SugarCRM. Пожалуйста, четко следуйте инструкциям.',
  ...
  'LBL_UW_START_DESC3' => 'Нажмите на кнопку <b>Вперед</b> для выполнения предварительной проверки. В процессе проверки будт проанализированы права доступа к файлам, привилегии базы данных и настройки сервера.',
  ...
  'LBL_UW_SUGAR_COMMUNITY_EDITION_LICENSE' => 'Sugar Community Edition 5.0 использует GNU Affero General Public License Version 3. Это обновление конвертирует вашу существующую лицензию в новую, отображенную ниже.',
  ...
  'LBL_LAYOUT_MERGE_TITLE' => 'Нажмите на кнопку <i>Вперед</i> для применения указанных изменений.',
  'LBL_LAYOUT_MERGE_TITLE2' => 'Нажмите на кнопку <i>Вперед</i> для завершения процесса обновления.',
