...
4) Click Schedule System Index. Make sure that crontab is set up to run cron.php. This will handle indexing as well as the fallback mechanism when the connection to the search engine is interrupted.',
  ...
  'LBL_METROTHEMEPRO_TITLE' => 'Metro Theme Pro',
  'LBL_METROTHEMEPRO_ADMIN_DESC' => 'Metro Theme Pro configuration',
  'LBL_METROTHEMEPRO_CONFIG_TITLE' => 'Settings',
  'LBL_METROTHEMEPRO_CONFIG_INFO' => 'Modify settings for theme features',
  'LBL_MAXRELATED' => 'Maximum number of related items in preview',
  'LBL_MAXNOTIFIC' => 'Maximum number of notifications',
  'LBL_SHOWNOTIFIC' => 'Show notifications in the top menu',
  'LBL_SHOWLOGO' => 'Show company logo in the top menu',
  'LBL_SHOWPREVIEW' => 'Show preview in ListView',
  'LBL_SHOWRELATED' => 'Show related records in preview',
  'LBL_SHOWLOGOTRUE' => 'Show',
  'LBL_SHOWLOGOFALSE' => 'Hide',
  'LBL_SHOWTRUE' => 'yes',
  'LBL_SHOWFALSE' => 'no',
  'LBL_SYNOLIA' => 'SYNOLIA',
