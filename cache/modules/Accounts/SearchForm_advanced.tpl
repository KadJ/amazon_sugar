...
<input type='text' name='{$fields.address_street_advanced.name}' 
	...
	<td scope="row" nowrap="nowrap" width='8.3333333333333%' >
		...
		<label for='phone_fax_advanced'>{sugar_translate label='LBL_FAX' module='Accounts'}</label>
    	</td>
	<td  nowrap="nowrap" width='25%'>
			

{if strlen($fields.phone_fax_advanced.value) <= 0}
{assign var="value" value=$fields.phone_fax_advanced.default_value }
{else}
{assign var="value" value=$fields.phone_fax_advanced.value }
{/if}  

<input type='text' name='{$fields.phone_fax_advanced.name}' id='{$fields.phone_fax_advanced.name}' size='30' maxlength='100' value='{$value}' title='' tabindex=''	  class="phone" >
