...
addToValidate('form_QuickCreate_Accounts', 'account_source', 'enum', false,'{/literal}{sugar_translate label='LBL_ACCOUNT_SOURCE' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'phone_office_2_c', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE_OFFICE_2' module='Accounts' for_js=true}{literal}' );
addToValidate('form_QuickCreate_Accounts', 'phone_office_3_c', 'phone', false,'{/literal}{sugar_translate label='LBL_PHONE_OFFICE_3' module='Accounts' for_js=true}{literal}' );
