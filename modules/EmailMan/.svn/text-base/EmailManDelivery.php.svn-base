...
do {
	...
	while(($row = $db->fetchByAssoc($result))!= null){
        ...
        if (!isset($template_status[$row['marketing_id']])) {
            ...
            if(!isset($GLOBALS['for_pdf_current_emailmarketing'])) {
                $GLOBALS['for_pdf_current_emailmarketing'] = array();
            }
            if(!isset($GLOBALS['for_pdf_current_emailmarketing'][$current_emailmarketing->id])) {
                $GLOBALS['for_pdf_current_emailmarketing'][$current_emailmarketing->id] = $current_emailmarketing;
            }
            $GLOBALS['for_pdf_current_emailmarketing_id'] = $current_emailmarketing->id;
