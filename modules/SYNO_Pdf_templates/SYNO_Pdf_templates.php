...
require_once('modules/SYNO_Pdf_templates/SYNO_Pdf_templates_sugar.php');
class SYNO_Pdf_templates extends SYNO_Pdf_templates_sugar {
	
	function SYNO_Pdf_templates(){	
		parent::SYNO_Pdf_templates_sugar();
	}
