...
class SYNO_Pdf_templatesController extends SugarController {
	function SYNO_Pdf_templatesController(){
		parent::SugarController();
	}

	public function process(){
        if((!is_admin($GLOBALS['current_user']) && (!is_admin_for_module($GLOBALS['current_user'], 'SYNO_Pdf_templates'))) && $this->action != 'checkPdfAvailable'){ 
