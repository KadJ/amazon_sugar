...
class SYNO_Pdf_templates_sugar extends Basic {
	var $new_schema = true;
	var $module_dir = 'SYNO_Pdf_templates';
	var $object_name = 'SYNO_Pdf_templates';
	var $table_name = 'syno_pdf_templates';
	...
	function SYNO_Pdf_templates_sugar(){	
		parent::Basic();
	}
