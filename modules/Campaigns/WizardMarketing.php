...
// Счетчик исходящих писем
$ss->assign("START_EMAIL_OUTBOUND_COUNTER", $mrkt_focus->start_email_outbound_conter);

// Настройки для кастомного SMTP-ящика
$ss->assign("CUSTOM_EMAIL_ENABLED", $mrkt_focus->custom_email_enabled ? 'checked' : '');
$ss->assign("CUSTOM_EMAIL_SMTP_SERVER", $mrkt_focus->custom_email_smtp_server);
$ss->assign("CUSTOM_EMAIL_SMTP_PORT", $mrkt_focus->custom_email_smtp_port);
$ss->assign("CUSTOM_EMAIL_USERNAME", $mrkt_focus->custom_email_username);
$ss->assign("CUSTOM_EMAIL_PASSWORD", $mrkt_focus->custom_email_password);
$ss->assign("CUSTOM_EMAIL_PROTOCOL_OPTIONS", get_select_options_with_id($app_list_strings["email_settings_for_ssl"], $mrkt_focus->custom_email_protocol));
