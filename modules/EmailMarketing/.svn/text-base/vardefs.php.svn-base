...
$dictionary['EmailMarketing'] = array('table' => 'email_marketing'
	...
	'created_by' =>
  	...
  	array (
        ...
        array (
            'name' => 'start_email_outbound_conter',
            'vname' => 'LBL_START_EMAIL_OUTBOUND_COUNTER',
            'type' => 'int',
            'len' => '11',
        ),
        'custom_email_enabled' =>
        array (
            'name' => 'custom_email_enabled',
            'vname' => 'LBL_CUSTOM_EMAIL_ENABLED',
            'type' => 'bool',
            'default' => '0',
        ),
        'custom_email_smtp_server' =>
        array (
            'name' => 'custom_email_smtp_server',
            'vname' => 'LBL_CUSTOM_EMAIL_SMTP_SERVER',
            'type' => 'varchar',
            'len' => '255',
        ),
        'custom_email_smtp_port' =>
        array (
            'name' => 'custom_email_smtp_port',
            'vname' => 'LBL_CUSTOM_EMAIL_SMTP_PORT',
            'type' => 'varchar',
            'len' => '255',
        ),
        'custom_email_protocol' =>
        array (
            'name' => 'custom_email_protocol',
            'vname' => 'LBL_CUSTOM_EMAIL_PROTOCO',
            'type' => 'enum',
            'len' => 100,
            'options' => 'email_settings_for_ssl',
        ),
        'custom_email_username' =>
        array (
            'name' => 'custom_email_username',
            'vname' => 'LBL_CUSTOM_EMAIL_USERNAME',
            'type' => 'varchar',
            'len' => '255',
        ),
        ...
        array (
            ...
            'vname' => 'LBL_CUSTOM_EMAIL_PASSWORD',
            'type' => 'varchar',
            'len' => '255',
        ),
  	'date_start' =>
