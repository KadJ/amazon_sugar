...
class EmailMarketing extends SugarBean
{
    ...
    var $custom_email_enabled;
    var $custom_email_smtp_server;
    var $custom_email_smtp_port;
    var $custom_email_protocol;
    var $custom_email_username;
    var $custom_email_password;
