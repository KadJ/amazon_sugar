...
$installdefs = array (
  ...
  array (
    ...
    array (
      ...
      'class' => 'AOS_Line_Item_Groups',
      'path' => 'modules/AOS_Line_Item_Groups/AOS_Line_Item_Groups.php',
      'tab' => false,
    ),
    6 => 
    array (
  ...
  array (
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/aos_accountsLayoutdefs.php',
      'to_module' => 'Accounts',
    ),
    2 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/aos_contactsLayoutdefs.php',
      'to_module' => 'Contacts',
    ),
    3 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/aos_opportunitiesLayoutdefs.php',
      'to_module' => 'Opportunities',
    ),
    4 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/layoutdefs/aos_projectLayoutdefs.php',
      'to_module' => 'Project',
    ),
  ),
  'relationships' => 
  ...
  array (
    ...
    5 => 
    array (
      'from' => '<basepath>/SugarModules/modules/AOS_Line_Item_Groups',
      'to' => 'modules/AOS_Line_Item_Groups',
    ),
    6 => 
    array (
  ...
  array (
    1 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/aos_accountsVardefs.php',
      'to_module' => 'Accounts',
    ),
    2 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/aos_contactsVardefs.php',
      'to_module' => 'Contacts',
    ),
    3 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/aos_opportunitiesVardefs.php',
      'to_module' => 'Opportunities',
    ),
    4 => 
    array (
      'from' => '<basepath>/SugarModules/relationships/vardefs/aos_projectsVardefs.php',
      'to_module' => 'Project',
    ),
  ),
);
