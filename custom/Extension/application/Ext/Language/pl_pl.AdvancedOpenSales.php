<?php 
/**
 * Modu³y Produkty, Wyceny & Fakturowanie
 * Rozszerzenie dla SugarCRM
 * @package Advanced OpenSales dla SugarCRM
 * @copyright SalesAgility Ltd http://www.salesagility.com
 * 
 * Ten program jest darmowym oprogramowaniem; mo¿esz go redystrybuowaæ oraz/i modyfikowaæ
 * go na zasadach licencji GNU AFFERO GENERAL PUBLIC LICENSE opublikowanej przez
 * Free Software Foundation; w wersji 3 Licencji, lub
 * (wedle uznania) ka¿dej nastêpnej wersji.
 *
 * To oprogramowanie jest udostêpnione z nadziej¹, ¿e bêdzie u¿yteczne,
 * ale bez ¯ADNEJ GWARANCJI	; Po szczegó³y zajrzyj do
 * GNU General Public Licens
 *
 * Kopiê GNU AFFERO GENERAL PUBLIC LICENSE powinieneœ otrzymaæ
 * wraz z tym oprogramowaniem; jeœli nie, zajrzyj na stronê http://www.gnu.org/licenses
 * lub napisz do Free Software Foundation,Inc., 51 Franklin Street,
...
$app_list_strings['discount_list']['Amount'] = 'Iloœæ';
...
$app_list_strings['invoice_status_dom']['Paid'] = 'Zap³acone';
$app_list_strings['invoice_status_dom']['Unpaid'] = 'Nie zap³acone';
